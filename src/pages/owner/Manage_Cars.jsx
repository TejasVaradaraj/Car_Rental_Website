  ...
  return (
    <div className='px-4 pt-10 md:px-10 w-full'>
        ...
        <div className='max-w-6xl w-full rounded-md overflow-hidden border border-borderColor mt-6'>
          ...
          <table className='w-full border-collapse text-left test-sm test-black-600'>
            ...
            <tbody>
              {cars.map((car, index)=>(
                <tr key={index} className='border-t border-borderColor'>
                  ...
                  <td className='p-3 max_md:hidden'>
                  ...
                  <td className='flex items-center p-3'>
                    <img src={car.isAvailable ? assets.eye_icon : assets.eye_close_icon} alt="" className='cursor-pointer'/>
